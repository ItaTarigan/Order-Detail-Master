<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NotAuthorized.aspx.cs" Inherits="BalitTanahPelayanan.Pages.Public.NotAuthorized" %>
...
<body>
    <div class="container">
        <div class="container-inner" style='background-image:url("/assets/img/notauthorized.png");background-repeat:no-repeat;'">
            ...
            <form id="loginForm" action="" runat="server" method="post" class="form-container form-ready">
                ...
                <h1>Anda tidak memiliki autorisasi untuk masuk ke halaman tersebut. Silakan login kembali.</h1>
                 <div class="main-note">
