<%@ Page Title="Evaluasi" Language="C#" MasterPageFile="~/Pages/Master/Evaluator.Master" AutoEventWireup="true" CodeBehind="EvaluasiHasilDetail.aspx.cs" Inherits="BalitTanahPelayanan.Pages.Private.Evaluator.EvaluasiHasilDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row mt-2" runat="server" id="DivRow1">
        <div class="col-lg">
            <h2>
                <asp:Label ID="txtRincian" runat="server" Text="Rincian No Pesanan:"></asp:Label>
    ...
    <div id="divContent" class="divClass">
        <div class="row mt-2" runat="server" id="DivRow2">
            ...
            <div class="col-lg-4" runat="server" id="BtnDownloadZip">
                <div class="card">
                    <div class="card-body">
            ...
            <div class="col-lg-4" runat="server" id="DivDownloadLampiran">
                <div class="card">
                    <div class="card-body">
        ...
        <div class="row mt-2" runat="server" id="DivRow3">
            <div class="col-lg">
                <h3>
                    <asp:Label ID="txtDaftarSampel" runat="server" Text="Daftar Sampel"></asp:Label>
                </h3>
            </div>
        ...
        <div class="row mt-2" runat="server" id="DivRow5">
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">
                            <asp:Label ID="txtketerangan1" runat="server" Text="Keterangan"></asp:Label>
                        </h5>
        ...
        <div class="row mt-2" runat="server" id="DivRow6">
            ...
            <div class="col-lg">
                ...
                <asp:Button ID="BtnApprove" CssClass="btn btn-success" runat="server" Text="Setujui" CommandName="Approve" OnClick="ActionButton" />
                <asp:Button ID="BtnReject" CssClass="btn btn-warning" runat="server" Text="Analisa Ulang" CommandName="Reject" OnClick="ActionButton" />
            </div>
        </div>
