<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Master/Customer.Master" AutoEventWireup="true" CodeBehind="CustomerBuatPesananTouch.aspx.cs" Inherits="BalitTanahPelayanan.Pages.Private.Customer.CustomerBuatPesananTouch" %>
                    ...
                    <div class="card">
                        ...
                        <asp:GridView CssClass="table table-bordered table-hover" ID="GvSample2" runat="server" AutoGenerateColumns="false" AllowPaging="false">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Koordinat GPS">
                                    <ItemTemplate>
                                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("latitude") +"," +Eval("longitude")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                    ...
                    <div class="card">
                        ...
                        <asp:GridView CssClass="table table-bordered table-hover" ID="GvParameter2" runat="server" AutoGenerateColumns="false" AllowPaging="false">
                            <Columns>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <asp:Label ID="Label3" runat="server">Pilih</asp:Label>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <asp:CheckBox ID="CheckBox1" Checked="true" runat="server" Enabled="false"></asp:CheckBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Parameter Uji" Visible="false">
                                    <ItemTemplate>
                                        <asp:HiddenField ID="HiddenField1" Value='<%# Eval("isMandatory") %>' runat="server" />
                                        <asp:Label runat="server" ID="Label4" Text='<%# Eval("elementId") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Parameter Uji">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="Label5" Text='<%# Eval("elementCode") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Tarif per Contoh">
                                    <ItemTemplate>
                                        <b>
                                            <asp:Label runat="server" ID="Label6" Text='<%# float.Parse( Eval("serviceRate").ToString()) %>'></asp:Label></b>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Jumlah Contoh">
                                    <ItemTemplate>
                                        <asp:TextBox runat="server" ReadOnly="true" ID="TextBox1" onkeypress="return isNumberKey(event)" Text="1" OnTextChanged="CalculateTotal" AutoPostBack="true" TextMode="Number"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Biaya">
                                    <ItemTemplate>
                                        <b>
                                            <asp:Label runat="server" ID="Label7" Text="0"></asp:Label></b>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
