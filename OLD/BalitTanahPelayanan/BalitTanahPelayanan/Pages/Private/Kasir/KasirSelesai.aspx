<%@ Page Title="Kasir - Pesanan Selesai" Language="C#" AutoEventWireup="true" MasterPageFile="~/Pages/Master/Kasir.Master" CodeBehind="KasirSelesai.aspx.cs" Inherits="BalitTanahPelayanan.Pages.Private.Kasir.KasirSelesai" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <br />
    <asp:Panel ID="PanelGridSelesai" runat="server">
            ...
            <div class="row mt-2">
                <div class="col-lg">
                    <h2>
                        ...
                        <span>
                            <asp:Literal ID="LitSelesai" runat="server"></asp:Literal></span></h2>
                </div>
                    ...
                    <asp:GridView runat="server" CssClass="table table-bordered table-hover" ID="GvData" AutoGenerateColumns="false">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Tindakan">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnRincian" runat="server" PostBackUrl='<%# "KasirSelesaiRincian.aspx?orderNo=" + Eval("orderNo") %>' CommandName="detail" Text="Rincian"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
