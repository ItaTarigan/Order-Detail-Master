<%@ Page Title="Kasir - Pesanan Diproses" Language="C#" MasterPageFile="~/Pages/Master/Kasir.Master" AutoEventWireup="true" CodeBehind="KasirProses.aspx.cs" Inherits="BalitTanahPelayanan.Pages.Private.Kasir.KasirProses" %>
            ...
            <div class="row mt-2">
                <div class="col-lg">
                    <h2>
                        ...
                        <span>
                            <asp:Literal ID="LitProses" runat="server"></asp:Literal></span></h2>
                </div>
                    ...
                    <asp:GridView runat="server" CssClass="table table-bordered table-hover" ID="GvData" AutoGenerateColumns="false">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Tindakan">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnRincian" runat="server" PostBackUrl='<%# "KasirProsesRincian.aspx?orderNo=" + Eval("orderNo") %>' CommandName="detail" Text="Rincian"></asp:LinkButton>

                                    <asp:LinkButton ID="BtnPrint" runat="server" CommandArgument='<%#Eval("orderNo") %>' CommandName="print" Text="Cetak Tanda Terima"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
