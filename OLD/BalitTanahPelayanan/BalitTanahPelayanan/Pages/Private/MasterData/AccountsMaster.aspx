<%@ Page Language="C#" MasterPageFile="~/Pages/Master/Admin.Master" AutoEventWireup="true" CodeBehind="AccountsMaster.aspx.cs" Inherits="BalitTanahPelayanan.Pages.Private.MasterData.Accounts" %>
        ...
        <ContentTemplate>
                ...
                <div class="row mt-2" id="DivRow3" runat="server">
                    <div class="col-lg">
                        <asp:GridView CssClass="table table-bordered table-hover dataTable no-footer" ID="GvData" runat="server" AutoGenerateColumns="false" AllowPaging="false" EmptyDataText="Data Kosong">
                            <Columns>
                                <asp:BoundField DataField="AccountNo" HeaderText="Kode pengguna" />
                                ...
                                <asp:TemplateField HeaderText="Aksi">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnEdit" CssClass="linkbtn" runat="server" CommandArgument='<%# Eval("AccountNo") %>' CommandName="ubah" Text="Ubah"></asp:LinkButton>
                                        <asp:LinkButton ID="btnLihat" CssClass="linkbtn" runat="server" CommandArgument='<%# Eval("AccountNo") %>' CommandName="lihat" Text="Lihat"></asp:LinkButton> <%--OnClientClick='<%#"fixGridView("+Eval("GvData")+"); return false;"%>'--%>
                                        <asp:LinkButton ID="btnHapus" CssClass="linkbtn" runat="server" CommandArgument='<%# Eval("AccountNo") %>' CommandName="hapus" Text="Hapus" OnClientClick="return confirm('Apakah anda yakin ingin menghapus?');"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
            ...
            <asp:Panel ID="PanelInput" Visible="false" runat="server">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox runat="server" TextMode="Password" ID="TxtPassword" CssClass="form-control" name="password"></asp:TextBox>
