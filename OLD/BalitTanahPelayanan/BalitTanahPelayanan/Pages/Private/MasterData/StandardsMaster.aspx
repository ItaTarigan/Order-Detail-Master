<%@ Page Language="C#" MasterPageFile="~/Pages/Master/Admin.Master" AutoEventWireup="true" CodeBehind="StandardsMaster.aspx.cs" Inherits="BalitTanahPelayanan.Pages.Private.MasterData.Standards" %>
        ...
        <ContentTemplate>
                ...
                <div class="row mt-2" id="DivRow3" runat="server">
                    <div class="col-lg">
                        <asp:GridView CssClass="table table-bordered table-hover dataTable" ID="GvData" runat="server" AutoGenerateColumns="false" AllowPaging="false" EmptyDataText="Data Kosong">
                            <Columns>
                                <asp:BoundField DataField="stdId" HeaderText="Kode" />
                                <asp:BoundField DataField="stdNo" HeaderText="Nomor Standar" />
                                <asp:BoundField DataField="comodityNo" HeaderText="Kode Komoditas" />
                                <asp:TemplateField HeaderText="Aksi">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnEdit" CssClass="linkbtn" runat="server" CommandArgument='<%# Eval("stdId") %>' CommandName="ubah" Text="Ubah"></asp:LinkButton>
                                        <asp:LinkButton ID="btnLihat" CssClass="linkbtn" runat="server" CommandArgument='<%# Eval("stdId") %>' CommandName="lihat" Text="Lihat"></asp:LinkButton>
                                        <asp:LinkButton ID="btnHapus" CssClass="linkbtn" runat="server" CommandArgument='<%# Eval("stdId") %>' CommandName="hapus" Text="Hapus" OnClientClick="return confirm('Apakah anda yakin ingin menghapus?');"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
            ...
            <asp:Panel ID="PanelInput" Visible="false" runat="server">
                <div class="form-group">
                    <label>Kode:</label>
                    <asp:Label ID="TxtStdId" runat="server" Visible="true" Text="Otomatis"></asp:Label>
                </div>
                <div class="form-group">
                    <label for="stdno">Nomor Standar:</label>
                    <asp:TextBox runat="server" ID="TxtStdNo" ValidationGroup="vg1" TextMode="SingleLine" CssClass="form-control" name="stdno"></asp:TextBox>
                    <asp:RequiredFieldValidator ControlToValidate="TxtStdNo" ValidationGroup="vg1" ID="RequiredFieldValidator1" runat="server" ErrorMessage="Silahkan nomor standar"></asp:RequiredFieldValidator>
                </div>
                <div class="form-group">
