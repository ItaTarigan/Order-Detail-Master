<%@ Page Language="C#" MasterPageFile="~/Pages/Master/ManagerTeknis.Master" AutoEventWireup="true" CodeBehind="OrderListManager.aspx.cs" Inherits="BalitTanahPelayanan.Pages.Private.OrderListManager" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h3><asp:Button ID="BtnOrderMasuk" runat="server" Text="Order Masuk" /></h3>
    <h3><asp:Button ID="BtnOrderProses" OnClick="BtnOrderProses_Click" runat="server" Text="Order Diproses" /></h3>
    ...
    <asp:Panel ID="PanelOrderMasuk" Visible="false" runat="server">
            ...
            <asp:GridView CssClass="table table-bordered table-hover dataTable" Visible="true" ID="gv2" runat="server" AutoGenerateColumns="false" AllowPaging="false" EmptyDataText="Data Kosong">
                    <Columns>
    ...
    <asp:Panel ID="PanelPIC" Visible="false" runat="server">
            ...
            <asp:GridView CssClass="table table-bordered table-hover dataTable" ID="gvPIC" runat="server" AutoGenerateColumns="false" AllowPaging="false" EmptyDataText="Data Kosong">
                    <Columns>
                        <asp:BoundField DataField="orderNo" HeaderText="nomor order" />
                        <asp:BoundField DataField="ordermastertbl.customertbl.customerName" HeaderText="nama customer" />
                       <asp:BoundField DataField="sampleNo" HeaderText="nomor sample" />
