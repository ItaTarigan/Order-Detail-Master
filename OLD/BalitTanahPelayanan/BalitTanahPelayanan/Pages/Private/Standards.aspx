...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:Panel ID="PanelInput" Visible="false" runat="server">
        ...
        <div class="form-group">
            ...
            <asp:RequiredFieldValidator ControlToValidate="TxtStandardNo" ValidationGroup="vg1" ID="RequiredFieldValidator1" runat="server" ErrorMessage="Silahkan isi standard no"></asp:RequiredFieldValidator>
        </div>
        <div class="form-group">
            ...
            <asp:RequiredFieldValidator ControlToValidate="DDComodity" ValidationGroup="vg1" ID="RequiredFieldValidator2" runat="server" ErrorMessage="Silahkan isi comodity no"></asp:RequiredFieldValidator>
        </div>
