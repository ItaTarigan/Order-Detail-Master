...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:Panel ID="PanelInput" Visible="false" runat="server">
        ...
        <div class="form-group">
            ...
            <asp:RequiredFieldValidator ControlToValidate="DDStdId" ValidationGroup="vg1" ID="RequiredFieldValidator1" runat="server" ErrorMessage="Silahkan isi standard Id"></asp:RequiredFieldValidator>
        </div>
        <div class="form-group">
            ...
            <asp:RequiredFieldValidator ControlToValidate="DDElement" ValidationGroup="vg1" ID="RequiredFieldValidator2" runat="server" ErrorMessage="Silahkan isi element code"></asp:RequiredFieldValidator>
        </div>
