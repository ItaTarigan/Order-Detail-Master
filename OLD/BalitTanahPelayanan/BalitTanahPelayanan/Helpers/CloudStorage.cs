...
namespace BalitTanahPelayanan.Helpers
{
    public class CloudStorage
    {
        public static async Task<bool> BlobPostAsync(byte[] data, string filename)
        {
            ...
            string storageConnectionString = ConfigurationManager.AppSettings["BlobStorageConnection"];
            string blobContainer = ConfigurationManager.AppSettings["DefaultBlobCountainer"];
    ...
    public class OnPremStorage
    {
        public static async Task<bool> BlobPostAsync(byte[] data, string filename, string Folder = "general")
        {
            try
            {
                ...
                string UploadPath = ConfigurationManager.AppSettings["UploadFolderPath"];
